    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if audio_url:
                ...
                await message.reply("Не удалось получить аудио.")
        else:
            await message.reply("Произошла ошибка при генерации речи, попробуйте повторить через минуту...")

    except Exception as e:
        await message.reply("Произошла ошибка: " + str(e))  # Ловим любые исключения